...
public interface TinkersBombHook {
    default void onTinkersBombExplosion(ModifierNBT modifiers, ModDataNBT persistentData, ModifierEntry modifier, EBomb bomb, LivingEntity attacker, BombExplodeContext context) {
    }
    default void afterTinkersBombExplode(ModifierNBT modifiers, ModDataNBT persistentData, ModifierEntry modifier, EBomb bomb, LivingEntity attacker, final List<LivingEntity> targets) {
    }
    default void beforeBombPiecesHit(ModifierNBT modifiers, ModDataNBT persistentData, ModifierEntry modifier, EBomb bomb, LivingEntity attacker, final List<LivingEntity> targets, Map<LivingEntity, Integer> hitted) {
    }
    default void afterBombPiecesHit(ModifierNBT modifiers, ModDataNBT persistentData, ModifierEntry modifier, EBomb bomb, LivingEntity attacker, LivingEntity target, int hitcount) {
    }
