...
public class TinkersInnovationFluids {
    ...
    public static FlowingFluidObject<ForgeFlowingFluid> mimicream = register("mimicream", 80);
    ...
    public static FlowingFluidObject<ForgeFlowingFluid> blood = register("blood", 50);
    public static FlowingFluidObject<ForgeFlowingFluid> hemolymph = register("hemolymph", 75);
    public static FlowingFluidObject<ForgeFlowingFluid> blazing_soul = register("blazing_soul", 2000);
    ...
    public static FlowingFluidObject<ForgeFlowingFluid> mudslime = register("molten_mudslime", 560);
    public static FlowingFluidObject<ForgeFlowingFluid> lightning = register_gas("lightning", 2500);
    ...
    private static FlowingFluidObject<ForgeFlowingFluid> register_gas(String name, int temperature) {
        return FLUIDS.register(name).type(hot(name).temperature(temperature).lightLevel(12).density(-2000)).block(MapColor.COLOR_RED, 12).bucket().flowing();
    }
}
