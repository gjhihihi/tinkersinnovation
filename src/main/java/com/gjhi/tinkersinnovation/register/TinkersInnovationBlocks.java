...
public class TinkersInnovationBlocks {
    ...
    public static RegistryObject<Block> enchantment_block = BLOCKS.register("enchantment_block", () -> new Block(GLASS_METAL));
    ...
    public static RegistryObject<Block> hostilium_block = BLOCKS.register("hostilium_block", () -> new Block(GLASS_METAL));
